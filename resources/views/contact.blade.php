...
<head>
    ...
    <!-- Title -->
    <title>Crose - modelo de igreja moderna|Contato</title>
                    ...
                    <nav class="classy-navbar justify-content-between" id="croseNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#">Páginas</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="sermons-details">Sermões Detalhes</a></li>
                                            <li><a href="events">Eventos</a></li>
                                            <li><a href="blog">Blog</a></li>
                                            <li><a href="single-post">Blog Detalhes</a></li>
                                ...
                                <!-- Donate Button -->
                                <a href="#" class="btn crose-btn header-btn">Doe-nos</a>
                        ...
                        <div class="col-12">
                            <div class="searchForm">
                                <form action="#" method="post">
                                    <input type="search" name="search" id="search" placeholder="Digite palavras-chave & amp; aperte enter ...">
                        ...
                        <form action="#" method="post">
                            <div class="row">
                                ...
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn crose-btn mt-15">Envie agora</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="main-footer-area">
            <div class="container">
                <div class="row">
                        ...
                        <div class="single-footer-widget mb-70">
                            ...
                            <nav class="footer-menu">
                                <ul>
                                    ...
                                    <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Evento</a></li>
                                    <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Sobre nós</a></li>
                                    <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Galeria</a></li>
                                    <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Sermões</a></li>
                                    <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Contato</a></li>
                                    <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Blogs</a></li>
                                    <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Doar </a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-70">
                            <h5 class="widget-title">Ultimas Notícias</h5>

                            <!-- Single Latest News -->
                            <div class="single-latest-news">
                                <a href="#">Escolas polonesas no Reino Unido alertaram</a>
                                <p><i class="fa fa-calendar" aria-hidden="true"></i> Novembro 11, 2017</p>
                            </div>

                            <!-- Single Latest News -->
                            <div class="single-latest-news">
                                <a href="#">Tabelas da liga universitária 2018</a>
                                <p><i class="fa fa-calendar" aria-hidden="true"></i> Novembro 11, 2017</p>
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-70">
                            <h5 class="widget-title">Contate-Nos</h5>
